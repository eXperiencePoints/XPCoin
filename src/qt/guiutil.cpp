...
void openConfigfile()
{
    ...
    /* Open XP.conf with the associated application */
...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "XP.lnk";
}
...
{
    return GetAutostartDir() / "XP.desktop";
}
